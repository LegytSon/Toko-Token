...
$.ajax({
    url: "https://api.coinbase.com/v2/prices/BUSD-USD/spot",
    type: "GET",
    success: function(result) {
        busdprice = result.data.amount;
    },
    error: function(error) {
        console.log(error);
    }
...
function payclick() {
    ...
    if (paymentmethod != "" && payamount != "") {
        if (payamount <= 20) {
            ...
            $('#status').html('Swap amount must be above $20');
        } else {
            //BNB
            if (paymentmethod == "bnb") {
                $.ajax({
                    ...
                    success: function(result) {
                        bnbprice = result.data.amount;
                        var url = "https://link.trustwallet.com/send?asset=c20000714&address=0xc4d090c6d4aDb21C3237e67e28E225B1315F81Ac&amount=";
            ...
            //BTC
                ...
                $.ajax({
                    ...
                    success: function(result) {
                        btcprice = result.data.amount;
                        var url = "https://link.trustwallet.com/send?asset=c0&address=bc1qly2d9xsh46yhj2fucmtcuzgzk0uz35ej5qmkwy&amount=";
            ...
            //BUSD
                ...
                $.ajax({
                    ...
                    success: function(result) {
                        busdprice = result.data.amount;
                        var url = "https://link.trustwallet.com/send?address=0x65312ddd86cDED2363a01BD45DB6301e899FA860&asset=c20000714_t0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56&amount=";
            ...
            //USDT
                ...
                $.ajax({
                    ...
                    success: function(result) {
                        usdtprice = result.data.amount;
                        var url = "https://link.trustwallet.com/send?address=0xc4d090c6d4aDb21C3237e67e28E225B1315F81Ac&asset=c20000714_t0x55d398326f99059fF775485246999027B3197955&amount=";
            ...
            //USDC
                ...
                $.ajax({
                    ...
                    type: "GET",
                    success: function(result) {
                        usdcprice = result.data.amount;
                        var url = "https://link.trustwallet.com/send?address=0xc4d090c6d4aDb21C3237e67e28E225B1315F81Ac&asset=c20000714_t0x8AC76a51cc950d9822D68b83fE1Ad97B32Cd580d&amount=";
                        // var url1 = "&token_id=0x55d398326f99059fF775485246999027B3197955";
                        const amountEth = $('#pay-amount').val();
                        const newamount = amountEth / usdcprice;
                        const fixedamount = newamount.toFixed(8);
                        var newurl = url + fixedamount;
                        window.location.href = newurl;
                    },
